...
# x = [randint(30, 1000) for i in range(0,500)]
# print x
import heapq
...
def findThreshold():
    ...
    count = -1
    while flag:
        initial_threshold = sorted(datapoints)[count]
        current_index = datapoints.index(initial_threshold)
        decrement = 4
        while current_index - decrement < 0:
            decrement -= 1
        i = current_index - decrement
        j = current_index
        try:
            while j < current_index+4:
                c = 0
                ...
                if c == 5:
                    flag = False
                    print datapoints[i:j+1], initial_threshold
                i += 1
                j += 1
        except:
            pass
